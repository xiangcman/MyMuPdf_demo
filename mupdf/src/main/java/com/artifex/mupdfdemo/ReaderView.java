...
public class ReaderView extends AdapterView<Adapter>
    ...
    private boolean longPressDisable = false;
    ...
    public boolean onDown(MotionEvent arg0) {
        Log.d("ReaderView", "onDown");
        mScroller.forceFinished(true);
        return true;
    }

    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        Log.d("ReaderView", "onFling");
    ...
    public void onLongPress(MotionEvent e) {
        if (!longPressDisable) {
            Log.d("ReaderView", "onLongPress");
            //这里直接选中文字
            MuPDFView pageView = (MuPDFView) getDisplayedView();
            pageView.longPressText(e);
        }
    }
    ...
    public void onShowPress(MotionEvent e) {
        Log.d("ReaderView", "onShowPress");
    }

    public boolean onSingleTapUp(MotionEvent e) {
        Log.d("ReaderView", "onSingleTapUp");
        return false;
    }

    public boolean onScale(ScaleGestureDetector detector) {
        Log.d("ReaderView", "onScale");
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        ...
        Log.d("ReaderView", "pointerCount:" + pointerCount);
        if (pointerCount == 1) {//如果是一只手指才会触发选中文字
